    ...
    if (e.shiftKey) {
      setSelectedNodes((prevSelectedNodes) => {
        ...
        return isAlreadySelected
          ? prevSelectedNodes.filter((snode) => snode.id !== node.id)
                ...
                <Tooltip title="Undo">
                  <IconButton
                    ...
                    sx={{
                      ...
                      '&:focus': {
                        outline: undoStack.length === 0 
                          ? 'none' 
                          : `2px solid ${isDark == true ? '#64B5F6' : '#2196F3'}`,
                        outlineOffset: '2px'
                      }
                    }}
                    tabIndex={0}
              ...
              {contextMenu.options.map((option) => (
                <div
                  ...
                  style={{
                    ...
                    display: 'flex',
                    alignItems: 'center',
                    borderBottom: contextMenu.options.length > 1 ? `1px solid ${isDark == true ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)'}` : 'none',
                  ...
                  onMouseEnter={(e) => (e.target.style.backgroundColor = isDark == true ? 'rgba(100,181,246,0.15)' : 'rgba(33,150,243,0.08)')}
