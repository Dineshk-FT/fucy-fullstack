...
export default function ORGate(props) {
  ...
  return (
    <>
      ...
      >
        <CustomHandle type="target" position={Position.Top} style={{ top: '27px', opacity: 0 }} isConnectable={1} />
        ...
        <Handle type="source" position={Position.Bottom} style={{ bottom: '35px', opacity: 0 }} />
