...
import { updateProceduresThreats } from './catalogData';
...
export default function UpdateProcedureTable() {
  ...
  useEffect(() => {
    ...
    const data = extractThreats(updateProceduresThreats);
    setRows(data);
        ...
        <Box display="flex" justifyContent="space-between" alignItems="center" my={1}>
          <Box display="flex" alignItems="center" gap={1}>
            ...
            <Typography sx={{ color: color?.title, fontWeight: 600, fontSize: '16px' }}>
                Vehicle update procedures and their risks Table
            </Typography>
          </Box>
          <Box>
            <TextField
